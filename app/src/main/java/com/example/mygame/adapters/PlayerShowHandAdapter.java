...
public class PlayerShowHandAdapter extends BaseAdapter<Card> {
    private static final String TAGHandSetter = "PlayerShowHandSetter";
    public PlayerShowHandAdapter(@NonNull List Gen, @Nullable OnViewHolderClickListener itemClickListener) {
    ...
    protected int[] getResIdOfInflatedViews() {
        return new int[]{
                R.id.Card, R.id.Headline, R.id.Picture, R.id.HP,
